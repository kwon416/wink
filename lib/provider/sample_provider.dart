...
class SampleProvider extends GetConnect {
  static SampleProvider get instance => Get.find();
  // Get request
  ...
  Future<Response> postPushNotification() async {
    final  header = {
      "Authorization": "Bearer key=AAAAzpC9Qmk:APA91bGpWj1uIQJWsj4XSGk9rcBUknFtUose_Pxz0vHYYgtvZ69KFLpHFrOfnUwWVdI71q-r34iwW0fzy7nxvn2WR3YCBUJd53d0RP8wQ353jZDoRpMU50SU0v7zvtlpcNKXF6qnoAzQ",
    ...
    final response = await post('https://fcm.googleapis.com/v1/projects/myproject-b5ae1/messages:send', body, headers: header);
    print(response.body);
